...
Download **DevTent Setup 1.1.1.exe** from [GitHub Releases](https://github.com/DubStepMad/devtent/releases).
...
Output: `packages/desktop/release/DevTent Setup 1.1.1.exe`
